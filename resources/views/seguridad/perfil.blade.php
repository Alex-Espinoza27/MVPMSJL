...
<div class="container">
    ...
    <form action="{{ route('actualizarUsuario') }}" class="form-parsley" method="POST" id="formActualizarPerfil"
            ...
            <div class="col-md-7">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" maxlength="12" minlength="9" class="form-control"
                    ...
                    <div class=" container m-3">
                        <button type="submit" name="actualizar" id="actualizar" class="btn btn-info"
                            {{-- onclick="confirmarCambio();"  --}}> Actualizar Datos</button>
                        ...
                        <div class="text-center dastone-profile-main">
                            <div class="dastone-profile-main-pic">
                                <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt=""
                                    height="110" id="profileImage" class="rounded-circle  w-50 h-auto">
                                <span class="dastone-profile_main-pic-change text-end "
                                    onclick="document.getElementById('profileInput').click()"> <i
