    ...
    <div class="modal-dialog modal-lg modal-dialog-start" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('administrar.registrar.Observacion') }}" class="form-parsley"
                ...
                <div class="container-fluid px-5 py-2">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea class="form-control w-100 text-dark" rows="4" id="P_MENSAJE_OBSERVACION" name="P_MENSAJE_OBSERVACION"
                    ...
                    <div class="row g-3 my-3">
                        <div class="col-md-6">
                            <label class="form-label" for="P_FECHA_LIMITE_SUBSANACION">
                                Fecha Límite de Subsanacíon: <span class="text-muted">(Opcional): La fecha debe ser mayor a la fecha actual</span>
                            </label>
                            <br>
                ...
                <div class="modal-footer">
                    <button type="button" id="btnValidarSolicitud" class="btn btn-purple" onclick="actualizarTipoOperacion('1');">
                        <i class="typcn typcn-tick"></i> REGISTRAR</button>
                    <button type="button" id="btnRegistrarObservacion" class="btn btn-outline-danger" onclick="actualizarTipoOperacion('2');">
                        <i class="typcn typcn-location-arrow"></i>ENVIAR OBSERVACION</button>
                    <button type="button" id="btnObservar" class="btn btn-soft-secondary btn-sm" data-bs-dismiss="modal">
                        <i class="typcn typcn-times"></i> CANCELAR</button>
                </div>
            </form>
        </div>
    </div>
